...
const initialAmenities = [
  ...
  { id: "kitchen", value: "Kitchen", checked: false, icon: "kitchen" },
  { id: "parking", value: "Free Parking", checked: false, icon: "garage_home" },
  { id: "washingmachine", value: "Washing Machine", checked: false, icon: "local_laundry_service" },
...
const AmenitiesField = ({ form }) => {
  const { Field } = form; // ✅ FIX — destructure Field to use as a React component
